...
using TuringClientErrorTypeDescription = EnumToString<TuringClientErrorType>::Create<
    EnumStringPair<TuringClientErrorType::UNKNOWN, "Unknown">,
    EnumStringPair<TuringClientErrorType::CANNOT_SEND_POST_REQUEST, "Could not send the post request">,
    EnumStringPair<TuringClientErrorType::TURING_QUERY_FAILED, "TuringDB Failed To Execute Query">,
    EnumStringPair<TuringClientErrorType::UNKNOWN_JSON_FORMAT, "Could not parse unknown json format">,
    EnumStringPair<TuringClientErrorType::INVALID_JSON_FORMAT, "Could not parse invalid json format">,
    EnumStringPair<TuringClientErrorType::UNKOWN_COLUMN_TYPE, "Type Of Result Column Is Unsupported">,
    EnumStringPair<TuringClientErrorType::CANNOT_SET_BEARER_TOKEN, "Could not set the bearer token">,
...
public:
    ...
    TuringClientError(TuringClientErrorType type,
