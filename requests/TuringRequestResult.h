...
using TuringRequestErrorTypeDescription = EnumToString<TuringRequestErrorType>::Create<
    ...
    EnumStringPair<TuringRequestErrorType::UNKNOWN_JSON_FORMAT, "Could not parse unknown json format">,
    EnumStringPair<TuringRequestErrorType::INVALID_JSON_FORMAT, "Could not parse invalid json format">,
